...
namespace TGDD.Api.Repositories
{
    public class ShoppingCartRepository : IShoppingCartRepository
    {
        ...
        {
            var x = await this.shopOnlineDbContext.CartItems.AnyAsync(c => c.CartId == cartId &&
        ...
        {
            var a = await CartItemExists(cartItemToAddDto.CartId, cartItemToAddDto.ProductId);
            if (a == false)
            {
